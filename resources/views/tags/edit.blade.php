    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500">Modify the configuration details for this tag.</p>
            </div>
            <nav class="flex text-sm text-gray-500" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    <li><a href="{{ route('tags.index') }}" class="hover:text-gray-700">Tags</a></li>
                    <li><span class="mx-2 text-gray-400">/</span></li>
                    <li class="font-medium text-gray-800" aria-current="page">Edit</li>
                </ol>
            </nav>
        </div>
    </x-slot>
        ...
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow-sm border border-gray-200 rounded-xl overflow-hidden">
                ...
                <div class="px-6 py-4 border-b border-gray-100 bg-gray-50/50">
                    <h3 class="text-base font-semibold text-gray-800">Edit Tag Details</h3>
                    <p class="text-xs text-gray-500 mt-0.5">Update the name associated with this tag.</p>
                </div>
